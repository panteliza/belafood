...
import bed1 from "../assets/images/2.JPG"; // Replace with your actual image path
import bed2 from "../assets/images/one.JPG"; // Replace with your actual image path
import woodenBg from "../assets/images/woodenbg.jpg"; // Replace with your wooden texture background
      ...
      >
        ...
        <motion.div variants={itemVariants} className=" space-y-6 text-center md:text-left">
          ...
          <p className="text-xl sm:text-xl text-white">
            Nestled in the serene hills of Namobuddha, Bela Farmhouse & Eatery offers you an unforgettable escape from the hustle and bustle. Enjoy cozy stays, local delicacies, and breathtaking views.
          </p>
